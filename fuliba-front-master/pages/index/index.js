...
Page({
  data: {
    ...
    swiperCurrent:0,
    navList: [
      { icon: '/image/nav-icon/Diamond.png', events: 'ToRecommond', text: 'PHP' },
      { icon: '/image/nav-icon/theme.png', events: 'toEntertain', text: 'HTML' },
       { icon: '/image/nav-icon/business.png', events: 'toTopline', text: 'Java' },
      { icon: '/image/nav-icon/all.png', events: 'toTechnology', text: 'Linux' }, 
      { icon: '/image/nav-icon/food.png', events: 'toLeisure', text: 'Python' }
